...
{ 
	...
	int hightest_left_block;//Variable holding the tallest block on left
	int hightest_right_block;//Variable holding the tallest block on right
...
//Size and values of the array introduced by the user
int size_user;
...
cout << endl;    
cout << "Please, press enter each time you introduce a value for the array. Thank you." <<endl;
